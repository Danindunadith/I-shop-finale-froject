...
function Crud() {
  ...
  const RowGen = () => {
    ...
    return filteredData.filter(repair => (repair.status === "Completed") && (repair.invoice !== "")).map((repair, index) => (
  ...
  return (
    ...
    <br></br><br></br>
      <div className="RepairTable">
        ...
        <table border={1} cellPadding={10} cellSpacing={0} /*className="table mb-0 align-middle"*/>
          <thead /*className="text-dark fs-4"*/>
            <tr className="text-black font-bold">
              ...
              <th /*className="border-bottom-0"*/>Invoice</th>
            </tr>
          </thead>
          <tbody>
            <RowGen />
