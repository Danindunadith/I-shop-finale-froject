...
function Crud() {
  ...
  const RowGen = () => {
    ...
    return filteredData.filter(repair => (repair.status === "Ongoing") || (repair.status === "Completed" && repair.invoice === "")).map((repair, index) => (
        ...
        >
          <thead /*className="text-dark fs-4"*/>
            <tr className="text-black font-bold">
              ...
              <th /*className="border-bottom-0"*/>Estimated Date</th>
